...
void SandRate(Int_t subrun = 0){
  ...
  TString qsdfilename[1] = {"../data/POT/E71b_ALL_POT/E71bALLPOT.root"};
  TString trkfilename[1] = {"../data/ST/E71b_ST_data.root"};
...
if((trig_sec[0]>=1700735626 && trig_sec[0]<=1700898139) || (trig_sec[0]>=1700903564 && trig_sec[0]<=1701070993) || (trig_sec[0]>=1701075572 && trig_sec[0]<=1701232497) || (trig_sec[0]>=1701239897 && trig_sec[0]<=1701316261) || (trig_sec[0]>=1701336021 && trig_sec[0]<=1701415009) || (trig_sec[0]>=1701431185 && trig_sec[0]<=1701478641) || (trig_sec[0]>=1701478689 && trig_sec[0]<=1702409668) || (trig_sec[0]>=1702446582 && trig_sec[0]<=1702518509) || (trig_sec[0]>=1702533973 && trig_sec[0]<=1702703554) || (trig_sec[0]>=1702797691 && trig_sec[0]<=1703136419) || (trig_sec[0]>=1703173071 && trig_sec[0]<=1703489501) || (trig_sec[0]>=1707637325 && trig_sec[0]<=1708187346) || (trig_sec[0]>=1708219820)){
    totalpot += ct_np[4][0];
    ct_np[4][0] /= 1.e15;
    daypot += ct_np[4][0];
}
