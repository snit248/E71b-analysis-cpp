...
void count_entries_xy_ToT() {
    ...
    TCanvas *cy = new TCanvas("cy", "Hit Count", 800, 600);
    TCanvas *cx = new TCanvas("cx", "Hit Count", 800, 600);
    ...
    legend->Draw();
    cy->Update();
    cy->SaveAs("../output/hit_count_y_ToT.png");
    ...
    legend->Draw();
    cx->Update();
    cx->SaveAs("../output/hit_count_x_ToT.png");
}
