...
//
    ...
    // キャンバスを保存
    TString filename;
    c1->SaveAs(("../output/ADCcompare/ADC_Histograms_"+ std::to_string(n1) +"_"+ std::to_string(n2) +"_"+  std::to_string(n3) +"_"+  std::to_string(n4) + ".png").c_str());
}